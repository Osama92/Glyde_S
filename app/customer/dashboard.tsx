...
//         if (!querySnapshot.empty) {
//           const userDoc = querySnapshot.docs[0].data();
//           fetchedDisplayName = userDoc.name || "Unknown User";
...
//       // Fetch shipments where the customer's name matches the displayName
//       const shipmentQuery = query(
//         collection(db, "Shipment"),
//         where("deliveries.customer", "==", fetchedDisplayName)
//       );
//       const shipmentSnapshot = await getDocs(shipmentQuery);

//       const fetchedShipments: any[] = [];
...
//               Delivery ID: {shipment.deliveries?.deliveryId || "N/A"}
//             </Text>
//             <StepIndicator
//               customStyles={customStyles}
//               currentPosition={1} // Adjust based on the actual progress
//               labels={labels}
//               stepCount={4}
//             />
//           </View>
