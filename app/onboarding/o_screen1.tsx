...
//   // Animation values (hook should not be inside condition)
...
//   const handlePress = () => {
//     buttonScale.value = withTiming(0.95, { duration: 150 }); // Scale down slightly
//     buttonOpacity.value = withTiming(0.8, { duration: 150 }); // Fade out slightly

//     // After animation, navigate to the next screen
//     setTimeout(() => {
//       router.push('/o_Screen2');
//     }, 200); // Give some time for the animation
//   };
