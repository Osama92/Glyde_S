...
const ShipmentScreen = () => {
  ...
  const renderShipmentItem = ({ item }: { item: any }) => (
    ...
    >
      ...
      <Text style={styles.shipmentText}>Description: {item.transporter || "No description"}</Text>
    </TouchableOpacity>
  );
...
const renderDeliveryItem = ({ item }: { item: any }) => (
    <View style={styles.tableRow}>
      <Text style={styles.tableCell}>{item.createdAt ? formatDate(item.createdAt) : "N/A"}</Text>
