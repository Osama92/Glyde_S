...
// import { View, Text, StyleSheet, ActivityIndicator, KeyboardAvoidingView,ScrollView,TouchableOpacity, Image, TextInput } from 'react-native';
...
//       <SearchableDropdown
//         items={transporters}
//         onItemSelect={(item: DropdownItem) => {setSelectedTransporter(item) ; setSelectedT(item.name)}} // Replace with your logic
...
//       <Text style={{color:'orange',marginBottom:10, fontWeight:'600', fontSize:18}}>Selected Transporter: {selectedT}</Text>
...
//             onItemSelect={(item: DropdownItem) => setSelectedItem(item.name)} // Replace with your logic
...
//             itemTextStyle={styles.itemText}
//           />
//           <Text style={{color:'orange',marginBottom:10, fontWeight:'600', fontSize:18}}>Selected Vehicle No: {selectedItem}</Text>
//         </>
//       )}
   

//    <Text style={styles.title}>Driver Detail / Others</Text>
...
export default function CreateShipment() {
  ...
  const generateShipmentId = () => {
    const randomPart = `${Math.floor(100 + Math.random() * 900)}RC`;
  ...
  const handleSaveShipment = async () => {
    ...
    try {
      ...
      //router.push(`/agent/shipment-detail?shipmentId=${shipmentId}`);
  ...
  return (
    <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={{ color: "orange", marginBottom: 10, fontWeight: "600", fontSize: 18 }}>
          Selected Transporter: {selectedT}
        </Text>
        ...
        {selectedTransporter && (
          <>
            ...
            />
            <Text style={{ color: "orange", marginBottom: 10, fontWeight: "600", fontSize: 18 }}>
              Selected Vehicle No: {selectedItem}
            </Text>
          </>
        )}
